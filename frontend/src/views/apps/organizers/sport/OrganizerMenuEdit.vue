  ...
  >
    <template #default="{ hide }">
      ...
      <div class="d-flex justify-content-between align-items-center content-sidebar-header px-2 py-1">
        <h5 class="mb-0">
          Редактирование пункта меню органайзера
        </h5>
  ...
  watch: {
    editItem(newItem) {
      ...
      this.itemData = {
        id: newItem.id,
        name: newItem.name,
        organizer_id: newItem.organizer_id,
      }
    },
  },
  methods: {
    onSubmit() {
      this.$refs.refFormObserver.validate().then(success => {
        ...
        axios.post(`/organizer/menu/${this.itemData.id}`, {
          name: this.itemData.name,
          organizer_id: this.itemData.organizer_id,
        }).then(() => {
