  ...
  >
    <template #default="{ hide }">
      ...
      <div class="d-flex justify-content-between align-items-center content-sidebar-header px-2 py-1">
        <h5 class="mb-0">
          Добавление таблицы органайзера
        </h5>
      ...
      >
        ...
        >
          ...
          >
            <b-form-group
              label="Наименование *"
              label-for="organizerItemName"
            >
              <b-form-input
                id="organizerItemName"
          ...
          >
            <b-form-group
              ...
              label-for="organizerItemLink"
            >
              <b-form-input
                id="organizerItemLink"
  ...
  methods: {
    onSubmit() {
      this.$refs.refFormObserver.validate().then(success => {
        ...
        axios.post('/organizer/item', {
          name: this.itemData.name,
          menu_id: this.organizerMenuId,
          ...
          this.$toast({
            component: ToastificationContent,
            props: {
              title: 'Ошибка при добавлении таблицы в органайзер',
