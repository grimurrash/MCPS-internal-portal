<template>
  ...
  <div>
    ...
    <template-add-new
      ...
      :is-double-options="isDoubleOptions"
      :document-type-options="documentTypeOptions"
      @refetch-data="refetchData"
    />

    <template-edit
      :is-edit-template-sidebar-active.sync="isEditTemplateSidebarActive"
      :is-double-options="isDoubleOptions"
      :document-type-options="documentTypeOptions"
    ...
    <templates-list-filters
      :document-type-filter.sync="documentTypeFilter"
      :is-double-filter.sync="isDoubleFilter"
      :document-type-options="documentTypeOptions"
      :is-double-options="isDoubleOptions"
    />
        ...
        <b-row>
          ...
          >
            <div class="d-flex align-items-center justify-content-end">
              ...
              >
                <span class="text-nowrap">Добавить новый шаблон</span>
              </b-button>
            </div>
          </b-col>
        </b-row>
      ...
      >
        ...
        <template #cell(actions)="data">
          ...
          >
            ...
            <b-dropdown-item @click.prevent="selectEditTemplate(data.item)">
              <feather-icon icon="EditIcon" />
              <span class="align-middle ml-50">Редактировать</span>
            </b-dropdown-item>

            <b-dropdown-item @click.prevent="fetchDeleteTemplate(data.item.id)">
...
<script>
import {
  BCard, BRow, BCol, BFormInput, BButton, BTable, BDropdown, BDropdownItem, BPagination, BFormCheckbox,
} from 'bootstrap-vue'
import axios from '@/libs/axios'
import ToastificationContent from '@core/components/toastification/ToastificationContent.vue'
import vSelect from 'vue-select'
import { ref, watch, computed } from '@vue/composition-api'
import TemplatesListFilters from '@/views/apps/documents/templates/TemplatesListFilters.vue'
import TemplateAddNew from '@/views/apps/documents/templates/TemplateAddNew.vue'
import TemplateEdit from '@/views/apps/documents/templates/TemplateEdit.vue'
...
export default {
  ...
  setup() {
    ...
    const selectEditTemplate = item => {
      ...
      isEditTemplateSidebarActive.value = true
    }

    const refetchData = () => {
      isEditTemplateSidebarActive.value = false
      isAddNewTemplateSidebarActive.value = false
