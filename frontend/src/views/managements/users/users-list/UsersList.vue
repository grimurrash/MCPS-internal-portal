<template>
  ...
  <div>
    ...
    <users-list-filters
      ...
      :permission-filter.sync="permissionFilter"
      :role-options="roleOptions"
      ...
      >
          ...
          <b-media vertical-align="center">
            <template #aside>
              <b-avatar
                ...
                :to="{ name: 'management-users-view', params: { id: data.item.id } }"
              />
            </template>
            <b-link
              :to="{ name: 'management-users-view', params: { id: data.item.id } }"
        ...
        <template #cell(actions)="data">
          ...
          >
            ...
            <b-dropdown-item :to="{ name: 'management-users-view', params: { id: data.item.id } }">
              <feather-icon icon="FileTextIcon" />
              <span class="align-middle ml-50">Подробнее</span>
            </b-dropdown-item>

            <b-dropdown-item :to="{ name: 'management-users-edit', params: { id: data.item.id } }">
              <feather-icon icon="EditIcon" />
              <span class="align-middle ml-50">Редактировать</span>
            </b-dropdown-item>

            <b-dropdown-item @click.prevent="fetchDeleteUser(data.item.id)">
